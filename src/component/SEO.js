...
const Seo = ({ title, description, image, url, lang }) => {
  ...
  const seoDescription =
    description ||
    defaultDescription[seoLang] ||
    defaultDescription[defaultLang];
  const seoImage = image || defaultImage;
  const seoUrl = url || defaultUrl;

  return (
    <Helmet htmlAttributes={{ lang: seoLang }} title={seoTitle}>
      <meta name="description" content={seoDescription} />
      <meta
        name="keywords"
        content="人工智能材料设计, 机器学习势函数, 材料基因组, 电池材料, 磁性材料, 密度泛函理论, 分子动力学, 电子科技大学, 电子科大,  基础与前沿研究院, 文明健, Mingjian Wen Group UESTC"
      />
      ...
      <meta
        ...
        content="文明健课题组 - Mingjian Wen Group UESTC"
      />
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          keywords:
            "人工智能材料设计, 机器学习势函数, 材料基因组, 电池材料, 磁性材料",
        })}
      </script>
    </Helmet>
  );
